...
try {
    ...
    if (-not($actionContext.DryRun -eq $true)) {
        Write-Information "Disable Planon account with accountReference: [$($actionContext.References.Account)]"
    ...
    $outputContext.AuditLogs.Add([PSCustomObject]@{
            Message = "Disable account was successful, Account property(s) updated: [$($actionContext.Data -join ',')]"
            IsError = $false
        })
    break
